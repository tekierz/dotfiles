...
func TestProductionToolsMutationCallsitesMatchAuditedManifest(t *testing.T) {
	...
	expectedMutations := map[string]mutationExpectation{
		...
		"claude_code.go:config.ApplyClaudeMCPSelectionAtRevisionTracked": {1, "plan-authority-bound Claude settings writer"},
		...
		"neovim.go:os.MkdirTemp":                                         {1, "HOME-private preset staging"},
		"neovim.go:safefile.ReadWithin":                                  {1, "descriptor-anchored staged preset read"},
		"neovim.go:safefile.RemoveDirectoryWithin":                       {2, "descriptor-anchored clone metadata and staging cleanup"},
		"neovim.go:safefile.ReplaceWithin":                               {1, "private staged preferences write"},
		"neovim.go:safefile.ReplaceWithinRevision":                       {1, "revision-bound staged init update"},
		"neovim.go:safefile.RestoreDirectoryWithinSnapshotTracked":       {1, "absent-target transactional preset commit with exact evidence"},
		"neovim.go:safefile.SnapshotDirectoryWithin":                     {2, "target preflight and immutable staged preset capture"},
		"neovim.go:safefile.VerifyDirectoryWithinSnapshot":               {1, "exact accepted Neovim directory authority preflight"},
		"tmux.go:exec.CommandContext":                                    {2, "bounded install-time TPM clone/plugin installer"},
		"tmux.go:os.MkdirTemp":                                           {1, "HOME-private TPM staging"},
		"tmux.go:safefile.RemoveDirectoryWithin":                         {1, "descriptor-anchored TPM staging cleanup"},
		"tmux.go:safefile.RestoreDirectoryWithinSnapshotTracked":         {1, "absent-target transactional TPM commit with exact evidence"},
		"tmux.go:safefile.SnapshotDirectoryWithin":                       {1, "immutable staged TPM capture"},
		"tmux.go:safefile.VerifyDirectoryWithinSnapshot":                 {1, "exact accepted TPM directory authority preflight"},
		"tool.go:os.MkdirAll":                                            {1, "external XDG trusted-root bootstrap"},
		"tool.go:operation.AcquireStateLock":                             {1, "private operational-state generated-config lock kernel"},
		"tool.go:safefile.EnsureDirectoryWithin":                         {1, "descriptor-anchored config parent bootstrap"},
		"tool.go:safefile.ReadWithin":                                    {2, "shared generated-config anchored read and observation kernel"},
		"tool.go:safefile.ReplaceWithin":                                 {1, "shared unconditional generated-config replacement kernel"},
		"tool.go:safefile.ReplaceWithinRevisionTracked":                  {1, "shared revision-bound replacement and exact evidence kernel"},
	}
	...
	expectedProtectedHelperCalls := map[string]int{
		"btop.go:preflightToolConfigAtRevision":         1,
		"btop.go:writeToolConfigAtRevisionTracked":      2,
		...
		"git.go:replaceToolConfigAtRevisionTracked":     4,
		...
		"tmux.go:writeToolConfigAtRevisionTracked":      1,
		"tmux.go:writeToolConfigTracked":                1,
		"tool.go:replaceToolConfigAtRevisionTracked":    3,
		"tool.go:writeGeneratedConfigWith":              1,
		"tool.go:writeToolConfigTracked":                1,
		"yazi.go:replaceToolConfigAtRevisionTracked":    2,
		"yazi.go:preflightToolConfigAtRevision":         1,
		"yazi.go:writeToolConfigAtRevisionTracked":      2,
