...
var manageConfigToolIDs = []string{
	toolGhostty, "tmux", "zsh", toolNeovim, "git", "yazi",
...
var manageAppliedRoundTrips = map[string]manageFieldRoundTrip{
	...
	// Tmux
	"tmux/prefix":            {func(mc *ManageConfig) { mc.TmuxPrefix = testTmuxPrefix }, ".tmux.conf", "set -g prefix C-b"},
	...
	"lazygit/paging":    {func(mc *ManageConfig) { mc.LazyGitPaging = optionNever }, ".config/lazygit/config.yml", "pager: cat"},
	...
	"glow/pager": {func(mc *ManageConfig) { mc.GlowPager = optionNever }, ".config/glow/glow.yml", "pager: false"},
