...
for truth in \
  ...
  'BA1SF2F closed branch-locally at `6c58f00`' \
  '44 catalog slices remain incomplete and 18 safety slices remain' \
  "RK1ULK's 2/1/1150 budget is a before-the-fact exception to the default 800-line ceiling for one indivisible private lifecycle authority." \
  'The 1150-line limit is a soft planning ceiling, not an implementation target; verification still requires the smallest reviewable two-file/one-production-file change.' \
